...
* [배열 붙이기(1)(np.hstack, np.vstack, np.concatenate)](./numpy/array_concat.md)
...
* [Decision Tree(추가설명 + 예제들(bmi ,mnist))](./machine_learning/Decision_Tree1.md)
...
* [결측치 정제하기(1)(확인, 제거)](./R/r12.md)
* [결측치 정제하기(2)(결측치 제외, 대체)](./R/r13.md)

* [이상치 정제하기(결측치로 만들어 정제)](./R/r14.md)
* [ggolot2(설명, 산점도)](./R/r15.md)
* [ggolot2(막대 그래프, 빈도 막대 그래프)](./R/r16.md)
* [ggolot2(선 그래프, 상자 그림)](./R/r17.md)
* 데이터 분석 프로젝트 1 (한국복지패널데이터)
  * [데이터 분석 준비](./R/ex1.md)
  * [성별에 따른 월급 차이](./R/ex2.md)
  * [나이에 따른 월급 차이](./R/ex3.md)
  * [연령대 별 월급 차이](./R/ex4.md)
  * [성별, 나이별 월급 차이, 연령, 나이별 월급 차이](./R/ex5.md)
  * [직업별 월급 차이](./R/ex6.md)
...
* [자연어 토크나이징 도구(1)(NLTK)](./nlp/nltk.md)
* [자연어 토크나이징 도구(2)(Konlpy)](./nlp/konlpy.md)
